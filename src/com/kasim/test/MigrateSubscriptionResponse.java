 ...
 *         &lt;element name="SubscriberMigrationResult" type="{http://www.avea.com.tr/pims/schema}SubscriberMigrationResult" maxOccurs="unbounded"/>
...
@XmlType(name = "", propOrder = {
    ...
    "subscriberMigrationResult",
    "transactionKey"
})
@XmlRootElement(name = "MigrateSubscriptionResponse")
public class MigrateSubscriptionResponse {

    @XmlElement(name = "ResultCode", required = true)
    protected String resultCode;
    @XmlElement(name = "ResultCodeDescription")
    protected String resultCodeDescription;
    @XmlElement(name = "SubscriberMigrationResult", required = true)
    protected List<SubscriberMigrationResult> subscriberMigrationResult;
    ...
    /**
     * Gets the value of the subscriberMigrationResult property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the subscriberMigrationResult property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getSubscriberMigrationResult().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link SubscriberMigrationResult }
     * 
     * 
     */
    public List<SubscriberMigrationResult> getSubscriberMigrationResult() {
        if (subscriberMigrationResult == null) {
            subscriberMigrationResult = new ArrayList<SubscriberMigrationResult>();
        }
        return this.subscriberMigrationResult;
    }
