 ...
 *         &lt;element name="ImmediateServiceStop" type="{http://www.w3.org/2001/XMLSchema}boolean"/>
...
@XmlType(name = "", propOrder = {
    ...
    "productKey",
    "reasonDescription",
    "immediateServiceStop",
    "namedParam"
})
@XmlRootElement(name = "StopAllSubscriptionsRequest")
public class StopAllSubscriptionsRequest {
    ...
    @XmlElement(name = "ImmediateServiceStop")
    protected boolean immediateServiceStop;
    ...
    /**
     * Gets the value of the immediateServiceStop property.
     * 
     */
    public boolean isImmediateServiceStop() {
        return immediateServiceStop;
    }

    /**
     * Sets the value of the immediateServiceStop property.
     * 
     */
    public void setImmediateServiceStop(boolean value) {
        this.immediateServiceStop = value;
    }
